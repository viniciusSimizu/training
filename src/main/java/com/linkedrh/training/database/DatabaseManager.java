...
public class DatabaseManager implements IDatabaseManager {
    ...
    private static Connection driverConn;
    private static int openConnections = 0;

    private AppConnection customConn = new AppConnection();

    public Connection getConnection() throws SQLException {
        if (DatabaseManager.openConnections <= 0) {
            ...
            DatabaseManager.driverConn = conn;
            DatabaseManager.openConnections++;
        }
        return this.customConn;
    }

    private class AppConnection implements Connection {

        @Override
        public void close() throws SQLException {
            DatabaseManager.openConnections--;
            if (DatabaseManager.openConnections <= 0) {
                DatabaseManager.driverConn.close();
            }
        }

        @Override
        public void commit() throws SQLException {
            DatabaseManager.driverConn.commit();
        }

        @Override
        public Statement createStatement() throws SQLException {
            return DatabaseManager.driverConn.createStatement();
        }

        @Override
        public Statement createStatement(int resultSetType, int resultSetConcurrency)
                throws SQLException {
            return DatabaseManager.driverConn.createStatement(resultSetType, resultSetConcurrency);
        }
        ...
        public CallableStatement prepareCall(String sql) throws SQLException {
            return DatabaseManager.driverConn.prepareCall(sql);
        }

        @Override
        public CallableStatement prepareCall(
                String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
            return DatabaseManager.driverConn.prepareCall(sql, resultSetType, resultSetConcurrency);
        }
        ...
        public CallableStatement prepareCall(
                ...
                throws SQLException {
            return DatabaseManager.driverConn.prepareCall(
                    sql, resultSetType, resultSetConcurrency, resultSetHoldability);
        }

        @Override
        public PreparedStatement prepareStatement(String sql) throws SQLException {
            return DatabaseManager.driverConn.prepareStatement(sql);
        }

        @Override
        public PreparedStatement prepareStatement(String sql, int autoGeneratedKeys)
                throws SQLException {
            return DatabaseManager.driverConn.prepareStatement(sql, autoGeneratedKeys);
        }

        @Override
        public PreparedStatement prepareStatement(String sql, int[] columnIndexes)
                throws SQLException {
            return DatabaseManager.driverConn.prepareStatement(sql, columnIndexes);
        }

        @Override
        public PreparedStatement prepareStatement(String sql, String[] columnNames)
                throws SQLException {
            return DatabaseManager.driverConn.prepareStatement(sql, columnNames);
        }

        @Override
        public PreparedStatement prepareStatement(
                String sql, int resultSetType, int resultSetConcurrency) throws SQLException {
            return DatabaseManager.driverConn.prepareStatement(
        ...
        public void rollback() throws SQLException {
            DatabaseManager.driverConn.rollback();
        }

        @Override
        public void rollback(Savepoint savepoint) throws SQLException {
            DatabaseManager.driverConn.rollback(savepoint);
        }
